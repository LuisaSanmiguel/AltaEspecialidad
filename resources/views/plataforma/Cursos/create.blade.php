      ...
      <thead>
                       ...
                       <tr>
                          ...
                          <tr>
                           ...
                           <tr>
                           <td class="text-center">Duración</td> <td class="text-center"><input style="width:100%" class="form-control" type="text" id="duracion" name="duracion" placeholder="Ingrese la duración " requiered /></td>
                            </tr>
                            <tr>
                           ...
                           <tr>
                           <td class="text-center">Objetivo General</td> <td class="text-center"><input class="form-control" style="width:100%" type="text" id="obj_general" name="obj_general" placeholder="Ingrese el Objetivo general"requiered /></td>
                            </tr>
                           ...
                           <tr>
                           <td class="text-center">Perfil Salida</td> <td class="text-center"><input class="form-control" style="width:100%" type="text" id="perfil_salida" name="perfil_salida" placeholder="Ingrese el Perfil de salida"requiered /></td>
                            </tr>
